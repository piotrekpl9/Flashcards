...
namespace Flashcards.Migrations
{
    ...
    [Migration("20250529233725_RemovePublicDeckRelationFromDeck2")]
    partial class RemovePublicDeckRelationFromDeck2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Flashcards.Models.PublicFlashcard", b =>
                {
                    b.HasOne("Flashcards.Models.PublicDeck", "PublicDeck")
                        .WithMany("PublicFlashcards")
                        .HasForeignKey("PublicDeckId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PublicDeck");
                });
